...
import AppComponents from '../AppItem'
import './index.css'
...
class AppStore extends Component {
  ...
  render() {
    ...
    const filteredApps = this.getFilteredAppList()
    const finalFilteredList = filteredApps.filter(eachApp =>
    ...
    return (
      <div className="bg_container">
        ...
        <div className="unordered-list-horizontal-line">
          <ul className="unordered-tabs-container">
        ...
        <ul className="unordered-AppItems-container">
          {finalFilteredList.map(eachApp => (
            <AppComponents each={eachApp} key={eachApp.appId} />
          ))}
        </ul>
      </div>
    )
